...
//Data assets json
gulp.task('jsonData', ['clean:dist'], function () {
...
gulp.task('copy:vendorjs', ['clean:dist'], function(){
  return gulp.src(['app/assets/scripts/vendor/jquery-2.1.4.min.js', 'app/assets/scripts/vendor/jquery.fancybox.pack.js'])
...
gulp.task('default', ['assemble', 'sass', 'fonts', 'notify:server', 'jsonData'], function(){
...
gulp.task('build', ['sass:dist', 'usemin', 'images', 'fonts:dist', 'copy:vendorjs','captions:dist', 'jsonData'], function(){
});